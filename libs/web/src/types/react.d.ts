...
declare module 'react/jsx-runtime' {
  namespace JSX {
    interface IntrinsicElements {
      ...
      'badge-box': BaseReactProps<'badge-box'>;
      'dialog-footer-box': BaseReactProps<'dialog-footer-box'>;
      'dialog-header-box': BaseReactProps<'dialog-header-box'>;
      'drawer-header-box': BaseReactProps<'drawer-header-box'>;
      'terminal-box': BaseReactProps<'terminal-box'>;
      'toolbar-box': BaseReactProps<'toolbar-box'>;
    }
