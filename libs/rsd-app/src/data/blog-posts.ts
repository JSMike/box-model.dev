...
- **Lower cognitive load.** Consumers shouldn’t stop to wonder whether it’s ${'`'}placement${'`'}, ${'`'}position${'`'}, or ${'`'}direction${'`'} this time.
...
- **Attributes reuse shared vocabularies.** If two components move or anchor something, they share the same ${'`'}attribute name and value set${'`'}.
