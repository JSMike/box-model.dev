...
1. Find the next available BOX-N number by scanning existing folders
2. Create `.issues/BOX-N/` directory
3. Create `.issues/BOX-N/issue.md` with template:
...
5. **Enter plan mode** with plan file at `.issues/BOX-N/plan.md`
...
1. Read all `.issues/BOX-*/issue.md` files
...
BOX-8: Button hover states fail contrast (high match)
  Status: ready | Priority: high
  → Use `/issue work BOX-8` to continue this issue

BOX-3: Stat delta colors need AA audit (partial match)
...
1. Scan all `.issues/BOX-*/issue.md` files
...
|----|-------|-------|------------|
| [BOX-1](./BOX-1/issue.md) | Title | Owner | - |
